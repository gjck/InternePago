<?php /* Smarty version 3.1.24, created on 2016-03-15 13:47:49
         compiled from "/Applications/MAMP/htdocs/PAGO 2/html/journalier_p8.html" */ ?>
<?php
/*%%SmartyHeaderCode:187976214256e80475c1f4c5_90274401%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e2084db9ce0b9c9da7e7df8cb12d11d49ee47d3' => 
    array (
      0 => '/Applications/MAMP/htdocs/PAGO 2/html/journalier_p8.html',
      1 => 1458045970,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187976214256e80475c1f4c5_90274401',
  'variables' => 
  array (
    'nb_pub' => 0,
    'nb_rdv' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_56e80475d07805_58583943',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56e80475d07805_58583943')) {
function content_56e80475d07805_58583943 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '187976214256e80475c1f4c5_90274401';
?>
<!DOCTYPE html>
...
>
  				...
  				<?php if ($_smarty_tpl->tpl_vars['nb_pub']->value == 0 || $_smarty_tpl->tpl_vars['nb_pub']->value < 0) {?>
					<?php if ($_smarty_tpl->tpl_vars['nb_pub']->value < 0) {?>
					<?php $_smarty_tpl->tpl_vars['max'] = new Smarty_Variable(0, null, 0);?>
					<?php }?>
				<?php } else { ?>
					<?php if ($_smarty_tpl->tpl_vars['nb_pub']->value < 50) {?>
					<?php $_smarty_tpl->tpl_vars['max'] = new Smarty_Variable($_smarty_tpl->tpl_vars['nb_pub']->value, null, 0);?>
					<?php } else { ?>
  					...
  					$(function()
  					{
    					var availableTags =
    						[
    							...
    							<?php
$_from = $_smarty_tpl->tpl_vars['listeNomPublicite']->value;
...
?>
				...
				<section id="bloc_middle">
					<form method="post" action="journalier_p9.php">
						<h2> Rendez-vous reprogrammés </h2>
						<p> Merci d'indiquer la date à laquelle vous avez prévu de revoir ces organismes publicitaires </p>
						<table id="table1">
							<tr>
						...
						<?php
$_from = $_smarty_tpl->tpl_vars['publiciteReprogrammes']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
?>
							<tr>
								...
								<td>  <select name="jour2[<?php echo $_smarty_tpl->tpl_vars['pub']->value['id'];?>
...
"> <?php echo $_smarty_tpl->tpl_vars['cpt']->value;?>
									  ...
									  <select name="mois2[<?php echo $_smarty_tpl->tpl_vars['pub']->value['id'];?>
...
"> <?php echo $_smarty_tpl->tpl_vars['cpt']->value;?>
									  ...
									  <select name="annee2[<?php echo $_smarty_tpl->tpl_vars['pub']->value['id'];?>
...
" />
						...
						<p> Merci d'indiquer les organismes publicitaires que vous avez vu aujourd'hui sans les avoir déclarés plus tôt </p>
						<?php if ($_smarty_tpl->tpl_vars['nb_pub']->value == 0 || $_smarty_tpl->tpl_vars['nb_pub']->value < 0) {?>
						<?php if ($_smarty_tpl->tpl_vars['nb_pub']->value < 0) {?> <?php $_smarty_tpl->tpl_vars['max'] = new Smarty_Variable(0, null, 0);?> <?php }?>
						<p> Vous n'avez pas rencontré d'organismes publicitaires supplémentaires aujourd'hui, vous pouvez passer à l'étape suivante </p>
						<?php } else { ?>
						<?php if ($_smarty_tpl->tpl_vars['nb_pub']->value < 50) {?>
						<?php $_smarty_tpl->tpl_vars['max'] = new Smarty_Variable($_smarty_tpl->tpl_vars['nb_pub']->value, null, 0);?>
						<?php } else { ?>
...
$_smarty_tpl->tpl_vars['cpt']->first = $_smarty_tpl->tpl_vars['cpt']->iteration == 1;$_smarty_tpl->tpl_vars['cpt']->last = $_smarty_tpl->tpl_vars['cpt']->iteration == $_smarty_tpl->tpl_vars['cpt']->total;?>
							<tr>
								<td> <input type="text" name="nom_pub[<?php echo $_smarty_tpl->tpl_vars['cpt']->value;?>
...
$_smarty_tpl->tpl_vars['cpt2']->first = $_smarty_tpl->tpl_vars['cpt2']->iteration == 1;$_smarty_tpl->tpl_vars['cpt2']->last = $_smarty_tpl->tpl_vars['cpt2']->iteration == $_smarty_tpl->tpl_vars['cpt2']->total;?>
							<tr>
								<td> <input type="text" name="nom_rdv_pub[<?php echo $_smarty_tpl->tpl_vars['cpt2']->value;?>
